(() => {
  const translations = {
    zh: {
      ...
      "index.hero.sub": "把 GMV 复盘、视频素材、脚本生成和订单分析放到同一入口，减少切表、找文件和来回确认的时间。",
      "index.hero.chip1": "GMV 复盘 · 素材查看 · 脚本生成 · 订单分析",
      "index.hero.chip2": "Daily Ops",
      "index.hero.chip3": "One Desk For The Team",
      "index.hero.panel.title": "今天先做什么",
      "index.hero.panel.badge": "4 个模块已就绪",
    ...
    en: {
      ...
      "index.hero.sub": "Bring GMV review, video assets, script generation, and order analysis into one entry point so the team spends less time switching sheets and tracking files.",
      "index.hero.chip1": "GMV Review · Video Hub · Script Generator · Order Analytics",
      "index.hero.chip2": "Daily Ops",
      "index.hero.chip3": "One Desk For The Team",
      "index.hero.panel.title": "Start Here Today",
      "index.hero.panel.badge": "4 modules ready",
